...
const SingleChat = () => {
  ...
  const { fetchSingleChat, isSingleChatLoading, singleChat, addNewMessage } =
    useChat();
  ...
  useEffect(() => {
    ...
    const handleNewMessage = (message: MessageType) => {
      if (message.chatId === chatId && message.sender?._id !== user?._id) {
  ...
  }, [chatId, socket, addNewMessage, user]);
